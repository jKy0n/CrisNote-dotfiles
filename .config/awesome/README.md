...
![awesome rc.lua](https://github.com/jKy0n/CrisNote-dotfiles/blob/master/Pictures/CrisNote-media/awesome_-_2025-11-07.png)

<details>
    <summary>🇧🇷 Descrição em Português:</summary>
        <br>
Basicamente este é o meu setup no CrisNote, muito semelhante ao que uso em todos os meus PCs.
...
<details>
    <summary>🇬🇧 English Description:</summary>
        <br>
This is basically my setup on CrisNote, very similar to what I use across all my machines.
